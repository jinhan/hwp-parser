...
H2TLib 란? 
=================================================
H2TLib는 한글(hwp) 문서에서 텍스트만 추출해주는 라이브러리 입니다.
...
이때의 라이선스 조건은 다음과 같습니다.
   ...
   - H2TLib 라이브러리의 jar 파일을 배포할때 jar 파일이 설치되는 폴더에 반드시 h2tlibLicense.txt 파일을 같이 포함시켜서 배포해야만 합니다.
...
모듈 정보
=================================================
rcc.h2tlib-1.0.1.jar(h2tlibLicense.txt 참고)
rcc.tikaparser-1.0.2.jar(h2tlibLicense.txt 참고)
poi-3.10-beta2.jar(poi-LICENSE-ASL.txt 참고, http://poi.apache.org/)
commons-io-2.0.1.jar(apache-commons-license.txt 참고, http://commons.apache.org/)
